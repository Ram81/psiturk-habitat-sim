...
python "${prefix}/download_unapproved_hits.py" --db_path "participants" --dump_path "${prefix}/data/hit_data/visualisation/unapproved_hits" --prefix demo --mode $mode --days 1 --from-date $current_dt
